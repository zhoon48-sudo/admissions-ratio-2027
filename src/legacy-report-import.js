const LEGACY_REPORTS = {
  ...
  '2026-09-08': {
    ...
    reportTime: '16:00',
    version: 'v1',
    note: '기존 경성대학교 경쟁률 모니터링 2일차 보고자료 수기 이관 · 16:00 기준 · legacy:v1',
    runId: -20260908,
    rows: [
      ['경성대학교','유웨이',2579,1817,2731,1950,'16:01','정상'],
      ['동아대학교','진학',3617,2314,4048,2578,'16:02','정상'],
      ['동의대학교','유웨이',3526,2417,3965,2735,'16:02','정상'],
      ['동서대학교','진학',1931,1422,2045,1520,'16:02','정상'],
      ['동명대학교','진학',1424,1022,1525,1063,'16:02','정상'],
      ['부산외국어대학교','진학',1394,1012,1574,1071,'16:02','정상'],
      ['신라대학교','진학',1366,1697,1477,1800,'16:02','정상'],
      ['고신대학교','유웨이',705,678,741,703,'16:02','정상'],
      ['부산가톨릭대학교','진학',677,612,715,659,'16:02','정상'],
      ['부산대학교','진학',3280,1766,3587,2109,'16:02','정상'],
      ['부경대학교','진학',2770,2131,2962,2357,'16:02','정상'],
      ['한국해양대학교','유웨이',1123,1023,1213,1135,'16:02','정상'],
      ['울산대학교','유웨이',2353,1095,2490,1192,'16:02','정상'],
      ['경남대학교','진학',1956,1291,2153,1452,'16:02','정상'],
      ['인제대학교','유웨이',1557,931,1645,1007,'16:02','정상'],
      ['영산대학교','진학',1261,854,1331,906,'16:02','정상'],
      ['경상국립대학교','진학',3437,3330,3729,3680,'16:02','정상'],
      ['창원대학교','진학',1578,1176,1725,1313,'16:02','정상']
    ]
  }
};
